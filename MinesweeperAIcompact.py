...
def AIAroundNumber(Grid,NewGrid,one,two,three):
    ...
    for Row in array[::three]:
        emptycount=0
        Row=int(Row)
        for Column in array[::three]:
            Column=int(Column)
            if NewGrid[Row][Column]!='-':
                ...
                if NewGrid[Row][Column]=='1':
                        ...
                        try:
                            ...
                            elif count==2 and NewGrid[Row-1][Column]=='1':
                                sidecount=0
                                try:
                                    for rrow in range(-1,2):
                                        for ccolumn in range(-1,2):
                                           if NewGrid[Row+i][Column+p]=='-':
                                               sidecount+=1
                                    if sidecount==3:
                                        UnlockSquare[Row-2][Column]
                                        UnlockSquare[Row-2][Column+1]
                                        UnlockSquare[Row-2][Column-1]
                    ...
                    for number in numberarray: 
                        if number!=1 and NewGrid[Row][Column]==str(number):
                            count=0
                            lolcount=0
                            othercount=0
                            for row in range(-1,2):
                               for column in range(-1,2):                           
                                   try:
                                       ...
                                       pass
                            if count==number and othercount==1:
                                flagging(crow,ccolumn,Grid)
...
def MinesweeperAI(Grid,NewGrid):
    ...
    while NewGrid[randomx][randomy]!='0':
            randomx=randint(0,25)
            randomy=randint(0,25)
            UnlockSquare(randomx,randomy,Grid,NewGrid)
